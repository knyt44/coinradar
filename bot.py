...
REVERSE_SIGNAL_STRENGTH_BONUS = 1.60
SAME_DIRECTION_SCORE_BONUS = 2.25

# =========================================================
# THRESHOLDS
# =========================================================
LONG_SCORE_THRESHOLD = 9.7
SHORT_SCORE_THRESHOLD = 9.7
NEUTRAL_USDTD_EXTRA_SCORE = 1.0
MIN_RR_TO_TP2 = 1.35
...
RESEND_IF_ENTRY_MOVED_PCT = 0.25
    ...
    if long_entry_ok and long_score >= LONG_SCORE_THRESHOLD:
        ...
        if rr >= MIN_RR_TO_TP2:
            ...
            candidates.append(build_signal_payload(
                ...
                tp3=tp3,
                score=long_score,
                strategy_tag="ETH_MEXC_15M_5M_USDTD_STRICT",
                reason=" | ".join(reasons),
                usdtd_bias=usdtd_bias
            ))
